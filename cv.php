    ...
    <main class="page cv-page">
        <section class="portfolio-block block-intro border-bottom">
            <div class="container">
                ...
                <div class="about-me">
                    <p>Hello! I am&nbsp;<strong>Faical El Jabli</strong>. I work as Web Developer. I have passion for writing clean codes, solving problems, challenging and developing my skills .</p><a class="btn btn-outline-primary" role="button" href="#">Hire me</a>
                </div>
            </div>
        </section>
        <section class="portfolio-block cv">
            <div class="container">
                <div class="work-experience group">
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h4 class="organization">Paradise-Inn</h4>
                            </div>
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-6">
                                <h3>Backend Developer&nbsp;</h3>
                                <h4 class="organization">Saley.Inc</h4>
                            </div>
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Web Developer</h3>
                                <h4 class="organization">Zaydtec</h4>
                            </div>
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Backend Developer</h3>
                                <h4 class="organization">Rest API</h4>
                            </div>
                            <div class="col-md-6"><span class="period">12/2017 - Present</span></div>
                        </div>
                        <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean eget velit ultricies, feugiat est sed, efficitur nunc, vivamus vel accumsan dui.</p>
                ...
                <div class="education group">
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>University&nbsp;</h3>
                                <h4 class="organization">Sidi Mohammed Ben Abdellah University&nbsp;</h4>
                            </div>
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>High School</h3>
                                <h4 class="organization">Ali Ben Barri High School</h4>
                            </div>
                ...
                <div class="education group">
                    <div class="heading">
                        <h2 class="text-center">Online Courses</h2>
                    </div>
                    <div class="item">
                        <div class="row">
                            <div class="col-md-6">
